...
import com.example.ngangainc.utility.FilePaths;
...
public class SettingsActivity extends AppCompatActivity implements ChangePhotoDialog.OnPhotoReceivedListener{
    ...
    private void getUserAccountData(){
        Log.d(TAG,"getUserAccData: getting");
...
//specify where the photo will be stored
        ...
        if(mBytes.length/MB < MB_THRESHHOLD) {
            ...
            StorageMetadata metadata = new StorageMetadata.Builder()
                     ...
                     */
                    .setCustomMetadata("Vic Metadata", "I love cartoons")
                    .setCustomMetadata("location", "Rabidds Invasion")
                    .build();
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        if (downloadUri != null) {
                            ...
                            String firebaseURL = downloadUri.toString(); //YOU WILL GET THE DOWNLOAD URL HERE !!!!
                            System.out.println("Upload " + firebaseURL);
...
//                   // Uri firebaseURL = storageReference.getDownloadUrl();
